...
namespace CitybankATMSystem
{
    class CitybankATM : ILogin, IBalance, IDeposit, IWithdrawal, IThirdPartyTransfer, ITransaction
    {
        ...
        public void Execute()
        {
            ...
            while (true)
            {
                switch (Utility.GetValidIntInputAmt("your option"))
                {
                    ...
                    case 2:
                        Console.Write("\nThank you for using CityBank. Exiting program now .");
        ...
        private static void LockAccount()
        {
            ...
            Console.WriteLine("Thank you for using CityBank. ");
            Console.ReadKey();
            System.Environment.Exit(1);
        }
